...
trait Localization
{
    ...
    public static function localeHasDiffOneDayWords($locale)
    {
        return static::executeWithLocale($locale, function ($newLocale, TranslatorInterface $translator) {
            return $newLocale &&
                $translator->trans('translate.diff_now') !== 'diff_now' &&
                $translator->trans('translate.diff_yesterday') !== 'diff_yesterday' &&
                $translator->trans('translate.diff_tomorrow') !== 'diff_tomorrow';
        });
    }
    ...
    public static function localeHasDiffTwoDayWords($locale)
    {
        return static::executeWithLocale($locale, function ($newLocale, TranslatorInterface $translator) {
            return $newLocale &&
                $translator->trans('translate.diff_before_yesterday') !== 'diff_before_yesterday' &&
                $translator->trans('translate.diff_after_tomorrow') !== 'diff_after_tomorrow';
        });
    }
    ...
    public static function localeHasPeriodSyntax($locale)
    {
        return static::executeWithLocale($locale, function ($newLocale, TranslatorInterface $translator) {
            return $newLocale &&
                $translator->trans('translate.period_recurrences') !== 'period_recurrences' &&
                $translator->trans('translate.period_interval') !== 'period_interval' &&
                $translator->trans('translate.period_start_date') !== 'period_start_date' &&
                $translator->trans('translate.period_end_date') !== 'period_end_date';
        });
    }
