...
class Team extends Model
{
    ...
    public function translate(){
        return $this->belongsTo(TeamTranslation::class, 'id', 'blog_id')->where('lang_code', admin_lang());
    }

    public function front_translate(){
        return $this->belongsTo(TeamTranslation::class, 'id', 'blog_id')->where('lang_code', front_lang());
    }
