...
@section('title')
    <title>{{ __('translate.WorkZone || Forget Password') }}</title>
@endsection
          ...
          <div class="container">
            <div class="row">
              <div class="col-auto">
                ...
                >
                  <h2 class="section-title-light mb-2">{{ __('translate.Forget Password') }}</h2>
            ...
            <div class="bg-white rounded-3 p-3">
              <div class="row g-4">
                <div class="col-lg-6 p-3 p-lg-5">
                  <div class="mb-40">
                    <h2 class="section-title mb-2">{{ __('translate.Forget Password') }}</h2>
                    <p class="section-desc">{{ __('translate.Welcome to Work Zone') }}</p>
                  </div>
                  <form method="POST" action="{{ route('buyer.send-forget-password') }}">
                    @csrf
                    <div class="form-container d-flex flex-column gap-4">
                      ...
                      <div class="d-grid">
                        <button class="w-btn-secondary-lg">{{ __('translate.Send Resend Link') }}</button>
                      </div>
                    </div>
                  </form>
                  <div class="py-5">
