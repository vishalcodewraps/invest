...
@section('title')
    <title>{{ __('translate.Buyer || Sign Up') }}</title>
@endsection
              ...
              <div class="row justify-content-center">
                <div class="col-auto">
                  <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('buyer.register') }}" class="w-form-btn">{{ __('translate.Buyer') }}</a>
                    <a href="{{ route('seller.register') }}" class="w-form-btn-outline">{{ __('translate.Seller') }}</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-3 p-3">
              <div class="row g-4">
                <div class="col-lg-6 p-3 p-lg-5">
                  ...
                  <form method="POST" action="{{ route('buyer.store-register') }}">
                    @csrf
