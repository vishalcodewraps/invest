...
@section('title')
    <title>{{ __('translate.Seller || Sign Up') }}</title>
@endsection
          ...
          <div class="container">
            <div class="row">
              <div class="col-auto">
                ...
                >
                  <h2 class="section-title-light mb-2">{{ __('translate.Sign Up') }}</h2>
              ...
              <div class="row justify-content-center">
                <div class="col-auto">
                  <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('buyer.register') }}" class="w-form-btn-outline">{{ __('translate.Buyer') }}</a>
                    <a href="{{ route('seller.register') }}" class="w-form-btn">{{ __('translate.Seller') }}</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-3 p-3">
              <div class="row g-4">
                <div class="col-lg-6 p-3 p-lg-5">
                  <div class="mb-40">
                    <h2 class="section-title mb-2">{{ __('translate.Sign Up') }}</h2>
                    <p class="section-desc">{{ __('translate.Welcome to Work Zone') }}</p>
                  </div>
                  <form method="POST" action="{{ route('seller.store-register') }}">
                    @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="d-grid">
                        <button class="w-btn-secondary-lg">{{ __('translate.Sign Up') }}</button>
                      </div>
                    </div>
                  </form>
                  <div class="py-5">
