                ...
                <ul class="dashboard-profile dropdown-menu">
                  ...
                  <li>
                    <a
                      ...
                      {{ __('translate.Post a job') }}
                    </a>
                  </li>
                  <li>
                    <a
                      class="dashboard-profile-item dropdown-item d-flex gap-2"
                      href="{{ route('buyer.jobpost.index') }}"
                      ><svg
                        width="21"
                        height="21"
                        viewBox="0 0 21 21"
