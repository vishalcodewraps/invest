          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-7 col-12">
                <div
                  class="bg-white p-5 rounded-3 not-found-img d-flex flex-column flex-wrap align-items-center"
                >
                  <img
                    src="{{ asset($general_setting->error_image) }}"
                    class="img-fluid"
                    alt=""
                  />
                </div>
                <div class="pt-5 text-center">
                  <h2 class="section-title mb-4">{{ __('translate.Oops! Page not found') }}</h2>
                  <div>
                    <a href="{{ route('home') }}" class="w-btn-secondary-lg d-inline-flex"
                      >{{ __('translate.Back to Home Page') }}</a
                    >
                  </div>
                </div>
              </div>
