                ...
                <div class="modal-body">
                    <form action="{{ route('admin.user-update', $user->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="crancy__item-form--group mg-top-form-20">
                                    <label class="crancy__item-label">{{ __('translate.Make Top Seller') }} </label>
                                    <div class="crancy-ptabs__notify-switch  crancy-ptabs__notify-switch--two">
                                        <label class="crancy__item-switch">
    ...
    <div class="modal fade" id="feezModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if($user->feez_status == 1)
                    <p>{{ __('translate.Do you really want to Un Freeze this profile? Also, Un Freeze all services provided by the author.') }}</p>
                    @else
                    <p>{{ __('translate.Do you really want to Freeze this profile? Also, Freeze all services provided by the author.') }}</p>
                    @endif
                </div>
                <div class="modal-footer">
