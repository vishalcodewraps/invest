...
@section('title')
    <title>{{ __('translate.Buyer Details') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('translate.Buyer Details') }}</h3>
    <p class="crancy-header__text">{{ __('translate.Manage Buyer') }} >> {{ __('translate.Buyer Details') }}</p>
@endsection
                    ...
                    <div class="crancy-ecom-card">
                        <div class="crancy-ecom-card__heading">
                            <div class="crancy-ecom-card__icon">
                                ...
                                <h4 class="crancy-ecom-card__title">{{ __('translate.Total Job') }} </h4>
                            </div>

                        </div>
                        <div class="crancy-ecom-card__content">
                            <div class="crancy-ecom-card__camount">
                                <h3 class="crancy-ecom-card__amount">{{ $total_job }}</h3>
                    ...
                    <div class="crancy-ecom-card">
                        <div class="crancy-ecom-card__heading">
                            <div class="crancy-ecom-card__icon">
                                ...
                                <h4 class="crancy-ecom-card__title">{{ __('translate.Hired Job') }}</h4>
                            </div>

                        </div>
                        <div class="crancy-ecom-card__content">
                            <div class="crancy-ecom-card__camount">
                                <h3 class="crancy-ecom-card__amount">{{ $total_hired }}</h3>
                    ...
                    <div class="overview-profile">
                        ...
                        <div class="overview-profile-item">
                            ...
                            <div class="overview-profile-inner">
                                ...
                                @if ($user->is_seller == 1)
                                    <a target="_blank" href="{{ route('freelancer', $user->username) }}" class="crancy-btn crancy-full-width mg-top-20"> <i class="fas fa-eye    "></i> {{ __('translate.Go To Public Profile') }}</a>
                                @endif

                                @if($user->feez_status == 1)
                                <button onclick="feezConfrimation({{ $user->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#feezModal"
                                    class="crancy-btn crancy-full-width  mg-top-20 bg-btn-custom"
                                    <i class="fas fa-feez"></i>
                                ...
                                <a onclick="itemDeleteConfrimation({{ $user->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn crancy-full-width mg-top-20 user_delete_btn"> <i class="fas fa-trash    "></i> {{ __('translate.Delete Seller') }}</a>
                                                    ...
                                                    <tbody class="crancy-table__body">
                                                        @foreach ($orders as $index => $order)
                                                            <tr class="odd">
                                                                ...
                                                                <td class="crancy-table__column-2 crancy-table__data-2">
                                                                    <h4 class="crancy-table__product-title"><a href="{{ route('admin.seller-show', $order->seller_id) }}">{{ html_decode($order?->seller?->name) }}</a></h4>
                                                                </td>
                                                                ...
                                                                <div class="dropdown">
                                                                        ...
                                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                            ...
                                                                            <li>
                                                                                <a onclick="orderDeleteConfrimation({{ $order->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="dropdown-item"><i class="fas fa-trash"></i> {{ __('translate.Delete') }}</a>
                                                                            </li>
